...
enum OGOzFMuArW5wB3CRvXLnAhL8W25uEJb8: String {
  case Team = "Team"
  case Ic_add = "ic_add"
  ...
  var RypGuylMln7YNqyN5j7nwCltyXnsdLbw: Image {
    return Image(s1ZNd5QU2H_UUnNcHh0fKsU72v0RAfQH: self)
  }
}

extension Image {
  convenience init!(s1ZNd5QU2H_UUnNcHh0fKsU72v0RAfQH: OGOzFMuArW5wB3CRvXLnAhL8W25uEJb8) {
    self.init(named: s1ZNd5QU2H_UUnNcHh0fKsU72v0RAfQH.rawValue)
  }
}
